...
AMyProject2Character::AMyProject2Character()
{
	...
	Mesh1P->SetRelativeRotation(FRotator(1.9f, -19.19f, 5.2f)); //RelativeRotation
	Mesh1P->SetRelativeLocation(FVector(-0.5f, -4.4f, -155.7f)); //RelativeLocation
	...
	//R_MotionController->hand Hand = EControllerHand::Right;
